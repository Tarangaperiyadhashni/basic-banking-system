      ...
      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="img2.jpg" class="d-block w-100 img-fluid"  alt="...">
      ...
      <!-- CArosoul part end -->
        ...
        <div class="container my-5">
            ...
            <div class="row row-cols-2">       
              ...
              <div class="col">
              <img src="img4.jpg" class="rounded img-fluid float-right" alt="...">
              </div>
            </div>
            </section>
      ...
      <div class="container">
        ...
        <div class="row content">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 " >
            <p>
              This is a Banking management system .Using this website users can keep a track of their money and even transfer money to their friends accordingly.
